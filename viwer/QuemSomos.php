...
<div id="TermosUso" class="container-fluid">
	    <div class="col-sm-8">
          <center>	                 
<h2>JUROS COMPOSTOS ONLINE</h2>            
<b>História</b>
<p> Fundada em 2021, com o acumulo de tempo livre durante a pandemia, resolvi somar esforços para ajudar as pessoas através de uma ferramenta fácil e intuitiva.</p>

<b>Diferenciais</b>
<p> O simulador de juros compostos vai encontrar o montante final para determinada quantia aplicada, trazendo um resultado detalhado comportando até três casas decimais.</p>
<p> É importante destacar que poucas ferramentas fazem cálculos de juntos compostos por HORA, DIAS, SEMANAS, MESES ou até mesmo ANOS.</p>
<p> Também temos uma calculadora cambial em nosso site, facilitando conversões de moeda.</p>

<b>Missão</b>
<p> Facilitar o dia a dia das pessoas.</p>

<b>Visão</b>
<p> Sempre buscar uma experiência do usuário para aprimorar a ferramenta, de modo simples e fácil através da nossa caixinha de mensagens.</p>

<b>Valores</b>
<p> Sempre respeitar nosso usuário, de modo que todos os dados do mesmo não serão coletados, velando sempre por sua privacidade e segurança.</p>
		  </center>  
    </div>
</div>
