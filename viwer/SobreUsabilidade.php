...
<div id="TermosUso" class="container-fluid">
	    <div class="col-sm-8">
          <center>	                 
<h2>USO NA SOCIEDADE</h2>            
<p>Em pequenas, médias e grandes empresas, os gestores tomam decisões todos os dias. Grande parte dessas decisões envolvem custos ou receitas ao longo do tempo. Que estão sujeitos a taxas de juros compostos.</p>

<p>No seu dia a dia uma pessoa comum tambem toma decisões, ou de investir determinado dinheiro ou em assumir detarminada divida.<p>

<p>Pensando em ajudar você, tanto na sua vida financeira pessoal, ou até mesmo profissional, desenvolvemos a ferramenta JUROS COMPOSTOS ONLINE.</p>
<p></p>
<p>Aqui está um exemplo de como a composição pode aumentar significativamente seu dinheiro. Neste exemplo hipotético, R$ 10.000 são investidos por três anos com um retorno de 5,5% composto anualmente. A cada ano, os ganhos crescem devido à capitalização. Ao final do terceiro ano, a soma principal vale R$ 11.742,41.</p>

<p>Valor do início do ano do ano Receitas anuais Valor do final do ano</p>

<p>No 1º ano R$ 10.000 ganha R$ 550 de juros, se tornando R$ 10.550</p>
<p>No 2º ano R$ 10.550 ganha R$ 580,25 de juros, se tornando R$ 11.130,25</p>
<p>E no 3º anos R$ 11.130,25 ganha R$ 612,16 de juros, chegando no montante final de $ 11.742,41</p>

<p>Os juros compostos não se aplicam apenas a contas de poupança e investimento. Contas à vista e certificados de depósito, como contas de poupança, também funcionam com o princípio dos juros compostos. Ativos como ações, fundos mútuos e ETFs também rendem juros. Coisas como empréstimos - incluindo hipotecas - e cartões de crédito também aplicam juros compostos, embora de uma forma que não beneficie você: Nesses casos, você acumula juros sobre sua dívida, o que significa que sua dívida tem a capacidade de sair rapidamente como uma bola de neve sem controle.</p>
		  </center>  
    </div>
</div>
