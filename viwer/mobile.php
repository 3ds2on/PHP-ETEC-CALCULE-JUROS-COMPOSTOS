...
<h6 class="fixed"><img alt="Advertisement" border="0" width="120" height="600" style="display:block"><script async src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js?client=ca-pub-7779498209865308"crossorigin="anonymous"></script></img></h6>
<h5 class="fixed5"><img alt="Advertisement" border="0" width="120" height="600" style="display:block"><script async src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js?client=ca-pub-7779498209865308"crossorigin="anonymous"></script></img></h5>
...
<nav class="navbar navbar-default navbar-fixed-top">
  <div class="container">
	...
	<!-- Container (PROPAGANDA GOOGLE) -->
	<script async src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js?client=ca-pub-7779498209865308"crossorigin="anonymous"></script>
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav navbar-right">
		...
		<li><a href="SobreJuros.php">SOBRE JUROS</a></li>
		<li><a href="SobreUsabilidade.php">SOBRE USABILIDADE</a></li>
	    ...
	    <div class="col-sm-8">
          <blockquote>	
		   <form method="post">
			...
			<p><b>Valor Inicial...: </b>
			<p><input name="txtValorInicialHora" id="txtValorInicialHora" type="number">
			<p><b>% por hora........: </b>
			<p><input name="txtPorcentagemHora" id="txtPorcentagemHora" type="number">
...
R: Imagine  que determinada 
forma de renda, gere um lucro de 
X % por hora.


<b>Para melhor compreensão, 
segue um exemplo pratico.</b>
"A contabilização de juros 
compostos de 1 % por hora,
entre 2021-04-01 00:00 
á 2021-04-01 10:00,
sobre o valor inicial de R$ 10,
obteve um valor final 
acumulado de R$ 11,046.


Valor inicial: R$ 10,00
Valor final com juros: R$ 11,046

<b>OBS: O valor final contém 3 
cassas decimais após a virgula.</b>
		   	</p></b>
		  </blockquote>  
		</div>	
    </div>
	...
	<div class="col-sm-7 slideanim">
	    <div class="col-sm-8">
          <blockquote>	
		   <form method="post">
			<span data-tooltip="Por gentileza, se atente a todos os campos: o juros será calculado de forma acumulativa."/>
			<h2><FONT COLOR="#24405d"><b>CALCULE JUROS AO DIA </b></FONT></h2></span>
			<p><b>Valor Inicial...: </b> <input name="txtValorInicialDia" id="txtValorInicialDia" type="number">
			<p><b>% ao dia...........: </b> <input name="txtPorcentagemDia" id="txtPorcentagemDia" type="number">
			<p><b>Data Inicial....: </b> <input name="txtdateinicialDia" id="txtdateinicialDia" type="date">
			<p><b>Data Final......: </b> <input name="txtdatefinalDia" id="txtdatefinalDia" type="date">
			<p>
			<p>
...
<br/> 
<p></p>
R: Imagine  que um boleto venceu, 
e á partir  de  determinada  data  
de  vencimento  será  cobrado  X %  
de juros  compostos  ao  dia.
<br/> 
<p></p>
<b>Para melhor compreensão, 
segue um exemplo pratico.</b>
"A contabilização de juros 
compostos de 1 % ao dia,
entre 2021-04-01 a 2021-04-10,
sobre o valor inicial de R$ 10,
Obteve um valor final acumulado 
de R$ 11,046.
<br/> 
<p></p>
Valor inicial: R$ 10,00
...
<div id="JurosSemanal" class="container-fluid">
	<div class="col-sm-7 slideanim">
		...
		<blockquote>	
		   <form method="post">
			<span data-tooltip="Por gentileza, se atente a todos os campos: o juros será calculado de forma acumulativa."/>
			<h2><FONT COLOR="#24405d"><b>CALCULE JUROS SEMANAIS </b></FONT></h2></span>
			<p><b>Valor Inicial...: </b> <input name="txtValorInicialSemanal" id="txtValorInicialSemanal" type="number">
			<p><b>% por semana...........: </b> <input name="txtPorcentagemSemanal" id="txtPorcentagemSemanal" type="number">
			<p><b>Data Inicial....: </b> <input name="txtdateinicialSemanal" id="txtdateinicialSemanal" type="date">
			<p><b>Data Final......: </b> <input name="txtdatefinalSemanal" id="txtdatefinalSemanal" type="date">
			<p>
			<p>
...
<br/> 
<p></p>
R: Imagine  que  você  emprestou 
um valor, e  você  vai  cobrar X  
% de juros  por cada  semana que 
demorar para receber seu dinheiro.
<br/> 
<p></p>
<b>Para melhor compreensão, 
segue um exemplo pratico.</b>
"A contabilização de juros 
compostos de 1 % por semana,
entre 2021-04-01 a 2021-04-10,
sobre o valor inicial de R$ 10,
Obteve um valor final acumulado 
de R$ 11,046.
  ...
  <div id="JurosMes" class="container-fluid"> 
    <div class="col-sm-7 slideanim">
		...
		<blockquote>	
		   <form method="post">
			<span data-tooltip="Por gentileza, se atente a todos os campos: o juros será calculado de forma acumulativa."/>
			<h2><FONT COLOR="#24405d"><b>CALCULE JUROS AO MÊS </b></FONT></h2></span>
			<p><b>Valor Inicial...: </b> <input name="txtValorInicialMes" id="txtValorInicialMes" type="number">
			<p><b>% ao mês...........: </b> <input name="txtPorcentagemMes" id="txtPorcentagemMes" type="number">
			<p><b>Data Inicial....: </b> <input name="txtdateinicialMes" id="txtdateinicialMes" type="date">
			<p><b>Data Final......: </b> <input name="txtdatefinalMes" id="txtdatefinalMes" type="date">
			<p>
			<p>
...
<br/> 
<p></p>
R: Imagine que você fez um investimento, 
e  você  vai 
receber X % de juros   por 	    
cada  mês  investido.
<br/> 
<p></p>
<b>Para melhor compreensão, 
...
<br/> 
<p></p>
<b>OBS: O valor final contém 
3 cassas decimais após a virgula.</b>
			</b></p> 
		  </blockquote>
		</div>	
    </div>
 ...
 <!-- Container (JurosAnual Section) -->
  ...
  <div class="col-sm-7 slideanim">
		...
		<blockquote>	
		   <form method="post">
			<span data-tooltip="Por gentileza, se atente a todos os campos: o juros será calculado de forma acumulativa."/>
			<h2><FONT COLOR="#24405d"><b>CALCULE JUROS AO ANO </b></FONT></h2></span>
			<p><b>Valor Inicial...: </b> <input name="txtValorInicialAno" id="txtValorInicialAno" type="number">
			<p><b>% ao ano...........: </b> <input name="txtPorcentagemAno" id="txtPorcentagemAno" type="number">
			<p><b>Data Inicial....: </b> <input name="txtdateinicialAno" id="txtdateinicialAno" type="date">
			<p><b>Data Final......: </b> <input name="txtdatefinalAno" id="txtdatefinalAno" type="date">
			<p>
			<p>
...
<br/> 
<p></p>
R: Imagine que você fez um 
investimento, e  você  vai 
receber  X  %  de  juros  
por  cada  ano  investido.
<br/> 
<p></p>
<b>Para melhor compreensão, 
segue um exemplo pratico.</b>
"A contabilização de juros 
compostos de 1 % ao ano,
